...
BEGIN
    IF _op_name = 'announce_node' THEN
        ...
        END IF;
    ELSIF _op_name = 'rotate_multisig' OR _op_name = 'transfer' OR op_name = 'transfer_to_savings' OR op_name = 'transfer_from_savings' OR op_name = 'interest' OR op_name = 'fill_transfer_from_savings' THEN
        _payload := _op_body;
    ELSE
